...
function add_css(target) {
  append_styles(target, "svelte-vhzpsp", ".layercake-container.svelte-vhzpsp,.layercake-container.svelte-vhzpsp *{box-sizing:border-box}.layercake-container.svelte-vhzpsp{width:100%;height:100%}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_if_block(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      add_location(div, file, 496, 1, 23210);
    },
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(496:0) {#if ssr === true || typeof window !== 'undefined'}",
    ctx
  });
  return block;
}
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("percentRange" in $$props2)
      $$invalidate(119, percentRange = $$props2.percentRange);
    if ("width" in $$props2)
      $$invalidate(120, width = $$props2.width);
    if ("height" in $$props2)
      $$invalidate(121, height = $$props2.height);
    ...
    if ("x" in $$props2)
      $$invalidate(122, x = $$props2.x);
    if ("y" in $$props2)
      $$invalidate(123, y = $$props2.y);
    if ("z" in $$props2)
      $$invalidate(124, z = $$props2.z);
    if ("r" in $$props2)
      $$invalidate(125, r = $$props2.r);
    if ("data" in $$props2)
      $$invalidate(126, data = $$props2.data);
    if ("xDomain" in $$props2)
      $$invalidate(127, xDomain = $$props2.xDomain);
    if ("yDomain" in $$props2)
      $$invalidate(128, yDomain = $$props2.yDomain);
    if ("zDomain" in $$props2)
      $$invalidate(129, zDomain = $$props2.zDomain);
    if ("rDomain" in $$props2)
      $$invalidate(130, rDomain = $$props2.rDomain);
    if ("xNice" in $$props2)
      $$invalidate(131, xNice = $$props2.xNice);
    if ("yNice" in $$props2)
      $$invalidate(132, yNice = $$props2.yNice);
    if ("zNice" in $$props2)
      $$invalidate(133, zNice = $$props2.zNice);
    if ("rNice" in $$props2)
      $$invalidate(134, rNice = $$props2.rNice);
    if ("xPadding" in $$props2)
      $$invalidate(135, xPadding = $$props2.xPadding);
    if ("yPadding" in $$props2)
      $$invalidate(136, yPadding = $$props2.yPadding);
    if ("zPadding" in $$props2)
      $$invalidate(137, zPadding = $$props2.zPadding);
    if ("rPadding" in $$props2)
      $$invalidate(138, rPadding = $$props2.rPadding);
    if ("xScale" in $$props2)
      $$invalidate(139, xScale = $$props2.xScale);
    if ("yScale" in $$props2)
      $$invalidate(140, yScale = $$props2.yScale);
    if ("zScale" in $$props2)
      $$invalidate(141, zScale = $$props2.zScale);
    if ("rScale" in $$props2)
      $$invalidate(142, rScale = $$props2.rScale);
    if ("xRange" in $$props2)
      $$invalidate(143, xRange = $$props2.xRange);
    if ("yRange" in $$props2)
      $$invalidate(144, yRange = $$props2.yRange);
    if ("zRange" in $$props2)
      $$invalidate(145, zRange = $$props2.zRange);
    if ("rRange" in $$props2)
      $$invalidate(146, rRange = $$props2.rRange);
    if ("xReverse" in $$props2)
      $$invalidate(147, xReverse = $$props2.xReverse);
    if ("yReverse" in $$props2)
      $$invalidate(148, yReverse = $$props2.yReverse);
    if ("zReverse" in $$props2)
      $$invalidate(149, zReverse = $$props2.zReverse);
    if ("rReverse" in $$props2)
      $$invalidate(150, rReverse = $$props2.rReverse);
    if ("xDomainSort" in $$props2)
      $$invalidate(151, xDomainSort = $$props2.xDomainSort);
    if ("yDomainSort" in $$props2)
      $$invalidate(152, yDomainSort = $$props2.yDomainSort);
    if ("zDomainSort" in $$props2)
      $$invalidate(153, zDomainSort = $$props2.zDomainSort);
    if ("rDomainSort" in $$props2)
      $$invalidate(154, rDomainSort = $$props2.rDomainSort);
    if ("padding" in $$props2)
      $$invalidate(155, padding = $$props2.padding);
    if ("extents" in $$props2)
      $$invalidate(156, extents = $$props2.extents);
    if ("flatData" in $$props2)
      $$invalidate(157, flatData = $$props2.flatData);
    if ("custom" in $$props2)
      $$invalidate(158, custom = $$props2.custom);
    if ("debug" in $$props2)
      $$invalidate(159, debug = $$props2.debug);
    if ("$$scope" in $$props2)
      $$invalidate(164, $$scope = $$props2.$$scope);
  };
  $$self.$capture_state = () => ({
    setContext,
    onMount,
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("context" in $$props2)
      $$invalidate(161, context = $$props2.context);
    if ("yReverseValue" in $$props2)
      $$invalidate(162, yReverseValue = $$props2.yReverseValue);
  };
  ...
  $$self.$$.update = () => {
    ...
    16842752) {
      $:
        $$invalidate(162, yReverseValue = typeof yReverse === "undefined" ? typeof yScale.bandwidth === "function" ? false : true : yReverse);
    }
    if ($$self.$$.dirty[3] & /*x*/
    536870912) {
      $:
        if (x)
          $$invalidate(160, config.x = x, config);
    }
    if ($$self.$$.dirty[3] & /*y*/
    1073741824) {
      $:
        if (y)
          $$invalidate(160, config.y = y, config);
    }
    if ($$self.$$.dirty[4] & /*z*/
    1) {
      $:
        if (z)
          $$invalidate(160, config.z = z, config);
    }
    if ($$self.$$.dirty[4] & /*r*/
    2) {
      $:
        if (r)
          $$invalidate(160, config.r = r, config);
    }
    if ($$self.$$.dirty[4] & /*xDomain*/
    8) {
      $:
        if (xDomain)
          $$invalidate(160, config.xDomain = xDomain, config);
    }
    if ($$self.$$.dirty[4] & /*yDomain*/
    16) {
      $:
        if (yDomain)
          $$invalidate(160, config.yDomain = yDomain, config);
    }
    if ($$self.$$.dirty[4] & /*zDomain*/
    32) {
      $:
        if (zDomain)
          $$invalidate(160, config.zDomain = zDomain, config);
    }
    if ($$self.$$.dirty[4] & /*rDomain*/
    64) {
      $:
        if (rDomain)
          $$invalidate(160, config.rDomain = rDomain, config);
    }
    if ($$self.$$.dirty[4] & /*xRange*/
    524288) {
      $:
        if (xRange)
          $$invalidate(160, config.xRange = xRange, config);
    }
    if ($$self.$$.dirty[4] & /*yRange*/
    1048576) {
      $:
        if (yRange)
          $$invalidate(160, config.yRange = yRange, config);
    }
    if ($$self.$$.dirty[4] & /*zRange*/
    2097152) {
      $:
        if (zRange)
          $$invalidate(160, config.zRange = zRange, config);
    }
    if ($$self.$$.dirty[4] & /*rRange*/
    4194304) {
      $:
        if (rRange)
          $$invalidate(160, config.rRange = rRange, config);
    }
...
function add_css2(target) {
  append_styles(target, "svelte-1bu60uu", "div.svelte-1bu60uu,slot.svelte-1bu60uu{position:absolute;top:0;left:0}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiSHRtbC5zdmVsdGUiLCJtYXBwaW5ncyI6IkFBbURDLGtCQUFHLENBQ0gsbUJBQUssQ0FDSixRQUFRLENBQUUsUUFBUSxDQUNsQixHQUFHLENBQUUsQ0FBQyxDQUNOLElBQUksQ0FBRSxDQUNQIiwibmFtZXMiOltdLCJpZ25vcmVMaXN0IjpbXSwic291cmNlcyI6WyJIdG1sLnN2ZWx0ZSJdfQ== */");
}
...
function add_css3(target) {
  append_styles(target, "svelte-u84d8d", "svg.svelte-u84d8d{position:absolute;top:0;left:0;overflow:visible}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiU3ZnLnN2ZWx0ZSIsIm1hcHBpbmdzIjoiQUErREMsaUJBQUksQ0FDSCxRQUFRLENBQUUsUUFBUSxDQUNsQixHQUFHLENBQUUsQ0FBQyxDQUNOLElBQUksQ0FBRSxDQUFDLENBQ1AsUUFBUSxDQUFFLE9BQ1giLCJuYW1lcyI6W10sImlnbm9yZUxpc3QiOltdLCJzb3VyY2VzIjpbIlN2Zy5zdmVsdGUiXX0= */");
}
...
function add_css4(target) {
  append_styles(target, "svelte-6sm8ei", "svg.svelte-6sm8ei{position:absolute;width:100%;height:100%;overflow:visible}svg.svelte-6sm8ei *{vector-effect:non-scaling-stroke}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
